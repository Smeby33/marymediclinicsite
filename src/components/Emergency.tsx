...
const Emergency = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-primary via-primary-light to-accent">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in-up">
          ...
          <div className="pt-4">
            <Button
              size="lg"
              onClick={handleCall}
              className="bg-foreground text-background hover:bg-foreground/90 px-12 py-6 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all"
            >
              Appeler
            </Button>
          </div>
