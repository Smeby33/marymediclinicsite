...
const Team = () => {
  return (
    <section id="equipe" className="py-20 bg-gradient-to-b from-primary/5 to-accent/5 overflow-hidden">
              ...
              <CarouselContent>
                {testimonials.map((testimonial, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <Card className="p-6 bg-gradient-to-br from-card to-card/50 border-2 hover:shadow-lg transition-all duration-300 hover:scale-105 h-full">
